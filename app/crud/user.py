...
class CRUDUser:
    ...
    async def get_by_email(self, email: str) -> Optional[UserInDB]:
        ...
        if user_data:
            ...
            user_dict.setdefault("is_member", False)
            user_dict.setdefault("membership_start", None)
            user_dict.setdefault("membership_expiry", None)
    ...
    async def create(self, user_data: dict) -> UserInDB:
        ...
        try:
            ...
            created_user.setdefault("is_member", False)
            created_user.setdefault("membership_start", None)
            created_user.setdefault("membership_expiry", None)
    ...
    async def update(self, user_id: Union[str, ObjectId], user_data: dict, return_updated: bool = True) -> Optional[UserInDB]:
        ...
        try:
            ...
            if updated_user:
                ...
                updated_user.setdefault("is_member", False)
                updated_user.setdefault("membership_start", None)
                updated_user.setdefault("membership_expiry", None)
